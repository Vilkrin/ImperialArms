<x-layouts.admin :title="__('Recruitment Management')">
                ...
                <div class="max-w-4xl">
                    <a href="recruitment.html" class="inline-flex items-center gap-2 px-3 py-2 text-sm text-slate-300 hover:text-amber-400 hover:bg-slate-800/50 rounded-lg transition-colors mb-4">
