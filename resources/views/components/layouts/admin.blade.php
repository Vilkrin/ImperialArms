        ...
        <aside id="sidebar" class="w-64 min-h-screen bg-slate-900/50 border-r border-slate-700">
            ...
            <nav class="p-4 space-y-6">
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li><a href="index.html" class="flex items-center gap-3 px-3 py-2 text-sm bg-amber-400/10 text-amber-400 font-medium rounded-l-md border-r-2 border-amber-400 hover:bg-slate-800/50 hover:text-amber-300 transition-colors"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5a2 2 0 012-2h4a2 2 0 012 2v6H8V5z"/></svg> Dashboard</a></li>
            ...
            <div class="mt-auto border-t border-slate-700 p-4">
                <a href="../index.html" class="flex items-center gap-3 px-3 py-2 text-sm text-amber-400 hover:bg-slate-800/50 hover:text-amber-300 transition-colors rounded-l-md border-r border-slate-700 hover:border-amber-400/60">
