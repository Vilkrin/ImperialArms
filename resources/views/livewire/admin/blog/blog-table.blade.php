<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <div class="bg-slate-900/50 border border-amber-400/20 backdrop-blur-sm rounded-lg shadow-sm">
            ...
            <div class="p-6 pt-0">
                <div class="text-2xl font-bold text-slate-100">{{ $totalPosts }}</div>
        ...
        <div class="bg-slate-900/50 border border-amber-400/20 backdrop-blur-sm rounded-lg shadow-sm">
            ...
            <div class="p-6 pt-0">
                <div class="text-2xl font-bold text-slate-100">{{ $publishedPosts }}</div>
        ...
        <div class="bg-slate-900/50 border border-amber-400/20 backdrop-blur-sm rounded-lg shadow-sm">
            <div class="p-6 pb-2">
                <h3 class="text-sm font-medium text-slate-400">Scheduled</h3>
            </div>
            <div class="p-6 pt-0">
                <div class="text-2xl font-bold text-slate-100">{{ $scheduledPosts }}</div>
                <p class="text-xs text-amber-400">Awaiting publication</p>
            </div>
        </div>
        ...
        <div class="bg-slate-900/50 border border-amber-400/20 backdrop-blur-sm rounded-lg shadow-sm">
            ...
            <div class="p-6 pt-0">
                <div class="text-2xl font-bold text-slate-100">{{ $draftPosts }}</div>
    ...
    <div class="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full xl:w-auto">
            <div class="relative w-full sm:w-80">
                ...
                <input
                    ...
                    class="flex h-10 w-full rounded-md border border-slate-700 bg-slate-900/50 px-3 py-2 text-sm pl-10 text-slate-100 placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-400"
                />
            </div>

            <select
                wire:model.live="status"
                class="flex h-10 w-full sm:w-40 rounded-md border border-slate-700 bg-slate-900/50 px-3 py-2 text-sm text-slate-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-400"
            >
            ...
            <select
                ...
                class="flex h-10 w-full sm:w-48 rounded-md border border-slate-700 bg-slate-900/50 px-3 py-2 text-sm text-slate-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-400"
            >
        ...
        <a
            ...
            class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-amber-400 text-slate-900 rounded-md text-sm font-medium hover:bg-amber-300 transition-colors"
        >
                ...
                <table class="w-full caption-bottom text-sm">
                    <thead class="[&_tr]:border-b">
                        <tr class="border-b border-slate-700 transition-colors hover:bg-slate-800/50">
                            <th class="h-12 px-4 text-left align-middle font-medium text-slate-400">Featured Image</th>
                            ...
                            <th class="h-12 px-4 text-left align-middle font-medium text-slate-400 hidden sm:table-cell">Categories</th>
                            <th class="h-12 px-4 text-left align-middle font-medium text-slate-400 hidden sm:table-cell">Tags</th>
                            <th class="h-12 px-4 text-left align-middle font-medium text-slate-400">Status</th>
                            <th class="h-12 px-4 text-left align-middle font-medium text-slate-400 hidden md:table-cell">Published</th>
                            <th class="h-12 px-4 text-left align-middle font-medium text-slate-400 w-12">Actions</th>
                        </tr>
                    </thead>
